...
## Changelog
- v **3.0.4** - 18.09.2024 - _bugfix_: the width and height stored in transforms were swapped and the output node would report them incorrectly. thanks @sky958958 for spotting it
